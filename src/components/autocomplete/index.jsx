...
// ** Custom Hooks
import { useOnClickOutside } from '@src/services/hooks/useOnClickOutside';

// ** Styles
import '@src/styles/scss/base/bootstrap-extended/_include.scss';
  ...
  const renderUngroupedSuggestions = () => {
    ...
    const sortSingleData = suggestions
      .filter((i) => {
        ...
        if (!startCondition && includeCondition) {
